...
public class Activity_MultiDeviceFilter extends Activity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        int i = 0;
        mDeviceTypeList.put(i++, DeviceType.ROWING_POWER);
        ...
        mDeviceTypeList.put(i++, DeviceType.ROWING_SPDCAD);
        mDeviceTypeList.put(i++, DeviceType.ROWING_CADENCE);
        mDeviceTypeList.put(i++, DeviceType.ROWING_SPD);
