...
public class BANALService
    ...
    public static final double DEFAULT_ROWING_CALIBRATION_FACTOR = 2.1;
        ...
        switch (sportType) {
            ...
            case ROWING:
                if (sensorTypes.contains(SensorType.POWER)) {
                    result = ActivityType.ROWING_POWER;
                } else if (sensorTypes.contains(SensorType.CADENCE)) {
                    result = ActivityType.ROWING_SPEED_AND_CADENCE;
                } else {
                    result = ActivityType.ROWING_SPEED;
                }
                break;
