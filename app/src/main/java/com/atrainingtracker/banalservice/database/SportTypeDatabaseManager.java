...
public class SportTypeDatabaseManager {
    ...
    public static class SportTypeDbHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            cv.put(SportType.GOLDEN_CHEETAH_NAME, TTSportType.ROWING.getGcName());
            cv.put(SportType.TCX_NAME, TTSportType.ROWING.getTcxName());
            cv.put(SportType.STRAVA_NAME, TTSportType.ROWING.getStravaName());
            cv.put(SportType.RUNKEEPER_NAME, TTSportType.ROWING.getRunkeeperName());
            cv.put(SportType.TRAINING_PEAKS_NAME, TTSportType.ROWING.getTrainingPeaksName());
